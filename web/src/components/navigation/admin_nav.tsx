...
<ul className="navbar-nav">
  <li className="logo">
    <a onClick={() => this.setActive("dash")} id="dash" className="nav-link">
  ...
  <li className="nav-item">
    <a onClick={() => this.setActive("create")} id="create" className="nav-link">

    <Icon iconName="CircleAddition" className="homeIcon" />
  ...
  <li className="nav-item">
    <a onClick={() => this.setActive("content")} id="content"  className="nav-link">
  ...
  <li className="nav-item">
    <a onClick={() => this.setActive("store")} id="store"  className="nav-link">
  ...
  <li className="nav-item">
    <a onClick={() => this.setActive("users")} id="users" className="nav-link">
