...
const headCells: HeadCell[] = [
  { id: 'name', numeric: false, disablePadding: true, label: 'content names' },
...
export default function EnhancedTable(props: any) {
  const rows = props.data.map((content: any) =>  createData( content.head, content.type, content.category, content.published_on, content.id))
