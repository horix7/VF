...
const  getStepContent: FunctionComponent<any> = (step: number) => {
    ...
    case 1:
      return (<>
        <div className="choicestepper">
          ...
          <ChoiceGroup defaultSelectedKey="MALE" selectedKey={target} options={options2} onChanged={(event: any) => setTarget(event.key)} />
        </div>
      </>);
    case 2:
     return (<>
      ...
      return (<>
         ...
         <div className="choicestepper">  
          ...
          <p className="higlight"> Which image looks most like you? </p>
           <ChoiceGroup defaultSelectedKey="MALE" selectedKey={bodyType} options={options3} onChanged={(event: any) => setbodyType(event.key)} />
         </div>
       </>);
    ...
    case 7:
      return (
        <>
          ...
          <TextField id="filled-basic" type="text" label="Your Name Address"  value={userName} onChange={(event: any) => setuserName(event.target.value)} />
